...
const SessionPage = () => {
  ...
  const contractSummaries = session?.contractSummaries || []
    ...
    <section className="flex h-full flex-col space-y-6">
      <header className="space-y-2">
        ...
        <p className="text-sm text-white/70">
          This portal will guide you through wallet connection, secure message signing, and automatic
          verification. Keep this tab open while you approve the signature in your Solana wallet.
        </p>
      </header>
